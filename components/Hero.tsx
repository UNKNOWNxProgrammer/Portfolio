  ...
  return (
    <div id='hero' className='bg-gray-100 bg-opacity-60 xl:gap-5 gap-16 h-full w-full justify-center flex flex-col xl:py-20 py-12'>
      ...
      <div className='flex flex-col w-full items-center justify-center xl:items-start xl:justify-start'>
          ...
          <img src="/hand.png" alt="" className='w-[60px] md:w-[80px]' />
          </div>
          ...
          <div className='mt-5 flex gap-5 items-center justify-center xl:items-start xl:justify-start  w-full'>
            <a href=""><img src="/icons/linkedin.svg" alt="" width={30} className='hover:text-blue-600 flex cursor-pointer' /></a>
            <a href=""><img src="/icons/github.svg" alt="" width={30} className='hover:text-blue-600 flex cursor-pointer' /></a>
          </div>  

      </div>

      <div className='flex items-center justify-center'>
        <img id='hero-img' src="https://static.vecteezy.com/system/resources/thumbnails/011/153/364/small_2x/3d-website-developer-working-on-laptop-illustration-png.png" alt="" className='xl:w-[750px] w-[400px] rounded-full border-gray-700 border-[6px] border-opacity-90'/>
      </div>
      </div>
      ...
      <div className='flex flex-col md:flex-row items-center gap-5 xl:justify-start justify-center uppercase text-lg md:px-8 w-full md:w-[90%] lg:w-[80%] xl:w-[80%] 2xl:w-[50%] 3xl:w-[40%] mx-auto h-full'>
        <div className='flex gap-5'>
         ...
         <div className='flex flex-row items-center md:flex-row gap-1 md:gap-2'>
            <img className='hover:scale-110 transition' src="/icons/html.png" alt="" width={70}/>
            <img className='hover:scale-110 transition' src="/icons/css.png" alt="" width={70}/>
            <img className='hover:scale-110 transition' src="/icons/javascript.png" alt="" width={70}/>
            <img className='hover:scale-110 transition' src="/icons/next.png" alt="" width={60}/>
            <img className='hover:scale-110 transition' src="/icons/tailwind.png" alt="" width={60}/>
         </div>
      </div>
